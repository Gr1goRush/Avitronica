...
public class AudioController : Singleton<AudioController>
{
    ...
    public void PlayOneShotRandom(AudioClip[] clips, float volume)
    {
        soundsSource.PlayOneShot(clips[Random.Range(0, clips.Length)], volume);
    }

    public void LoadGameMusic()
    {
        musicSource.clip = Resources.Load<AudioClip>("Music/GameMusic");
        musicSource.Play();
    }
}